...
class UserController {
   ...
   */
  public postUpdateProfile(req: Request, res: Response, next: NextFunction) {
   ...
   */
  public postUpdatePassword(req: Request, res: Response, next: NextFunction) {
    req.assert("password", "Password must be at least 4 characters long").len(4);
    req.assert("confirmPassword", "Passwords do not match").equals(req.body.password);
   ...
   * Delete user account.
   */
  public postDeleteAccount(req: Request, res: Response, next: NextFunction) {
   ...
   */
  public getOauthUnlink(req: Request, res: Response, next: NextFunction) {
